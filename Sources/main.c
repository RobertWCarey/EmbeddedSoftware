...
OS_THREAD_STACK(DORPhaseATimingThreadStack, THREAD_STACK_SIZE);
OS_THREAD_STACK(DORPhaseBTimingThreadStack, THREAD_STACK_SIZE);
OS_THREAD_STACK(DORPhaseCTimingThreadStack, THREAD_STACK_SIZE);
